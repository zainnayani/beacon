					...
					<table class="table mt-2">
						<thead class="thead-dark">
							<tr>
								...
								<th scope="col">Enter info Title</th>
								<th scope="col">Enter description</th>
							</tr>
						</thead>
						<tbody>
							<?php
							$count = 1;
							foreach ($uniData as $university ) {
							?>
							<tr>
								<th scope="row"><?=$count?></th>
								<td><?=$university->uni_name?></td>
								<td><?=$university->prog_name?></td>
								<td><?=$university->course_name?></td>
								<td><?=$university->info_title?></td>
								<td><?=$university->info_description?></td>
							</tr>
							<?php
							$count++;
							}
